...
# Last edited on 2017/01/14 --> clean/shuffle option and help message
# Last edited on 2017/01/17 --> fixed the help message and clean the script
# 
# SETTING:
           ...
           then
               ...
               if [ $iter -lt $iterations ] 
                  then
                      ...
                      if [ ${#container[*]} -gt "1"" ]; then shuffle=`cat /dev/urandom | tr -cd 'a-z0-9' | head -c 1`; fi
